...
class Property
{
    ...
    #[Groups(['property:read', 'property:write', 'demande:read', 'historique:read', 'payment:read'])]
    ...
    #[ORM\OneToMany(targetEntity: Availability::class, mappedBy: 'property', cascade: ['persist', 'remove'])]
