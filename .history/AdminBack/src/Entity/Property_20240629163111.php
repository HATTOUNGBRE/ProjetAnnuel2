...
class Property
{
    ...
    public function addReservationVoyageur(ReservationVoyageur $reservationVoyageur): static
    {
        if (!$this->reservationVoyageurs->contains($reservationVoyageur)) {
            $this->reservationVoyageurs->add($reservationVoyageur);
    ...
    public function removeReservationVoyageur(ReservationVoyageur $reservationVoyageur): static
    {
