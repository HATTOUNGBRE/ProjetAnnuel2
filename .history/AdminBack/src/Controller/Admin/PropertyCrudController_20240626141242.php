...
class PropertyCrudController extends AbstractCrudController
{
    ...
    public const PROPERTIES_BASE_PATH = 'uploads/image/properties';
    public const PROPERTIES_UPLOAD_DIR = 'public/uploads/image/properties';
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('name'),
            TextField::new('commune')->capitalize(),
