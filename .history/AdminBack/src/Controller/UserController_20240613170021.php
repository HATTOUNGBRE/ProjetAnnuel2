...
class UserController extends AbstractController
{
    ...
    public function register(Request $request, ValidatorInterface $validator, UserPasswordHasherInterface $passwordHasher, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($imageProfile) {
            ...
            try {
                ...
                return new JsonResponse(['message' => 'Failed to upload profile image'], Response::HTTP_INTERNAL_SERVER_ERROR);
            }
        } else {
