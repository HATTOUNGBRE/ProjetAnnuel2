...
class ReservationVoyageurController extends AbstractController
{
    ...
    #[Route('/api/properties/{propertyId}/reservations', name: 'property_reservations', methods: ['GET'])]
    public function getPropertyReservations(int $propertyId, PropertyRepository $propertyRepository): JsonResponse
    {
        $property = $propertyRepository->find($propertyId);
        ...
        $reservations = $property->getReservationVoyageurs();
