...
class PropertyController extends AbstractController
{
    ...
    public function create(
        ...
        if (!$proprioId) {
            return new JsonResponse(['message' => 'L\'identifiant du propriétaire est manquant.'], 400);
        }
    ...
    public function update(
        ...
        $property->setCommune($data['commune'] ?? $property->getCommune()); // Mise à jour du champ commune
        ...
        $responseData = [
            ...
            'commune' => $property->getCommune(), // Ajout du champ commune
        ];
