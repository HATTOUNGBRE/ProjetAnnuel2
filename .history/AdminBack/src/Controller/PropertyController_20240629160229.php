...
#[Route('/api/properties/{id}', name: 'get_property', methods: ['GET'])]
    public function getProperty(int $id, PropertyRepository $propertyRepository): JsonResponse
    {
        $property = $propertyRepository->find($id);
