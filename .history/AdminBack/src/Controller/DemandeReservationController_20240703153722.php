...
#[Route('/api/demandes/{id}/accept', name: 'accept_demande_reservation', methods: ['POST'])]
    public function acceptDemandeReservation(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'Demande acceptée avec succès et réservation créée'], JsonResponse::HTTP_OK);
    }
    ...
    public function __construct(ReservationVoyageurRepository $reservationVoyageurRepository, SerializerInterface $serializer)
    {
