    ...
    <div className="flex h-screen">
      <div className={`w-1/2 ${theme.backgroundColor} flex items-center justify-center`}>
        <div className="text-white text-center px-6 py-8">
          <div className="bg-gray-600 text-white rounded-lg p-3 mb-10 pt-3 pb-1 m-3 font-semibold">
          ...
          <form className="flex flex-col w-full max-w-md mx-auto">
            ...
            {questions.length > 0 && (
              <select
                ...
                required
              >
                <option placeholder="Choisissez " value="">Choisissez une question...</option>
