        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="w-full bg-blue-500 text-white py-2 px-4 rounded-lg focus:outline-none focus:ring-4 focus:ring-blue-500 hover:bg-blue-600 transition">Créer Prestation</button>
                </form>
            </div>
        </div>
    );
