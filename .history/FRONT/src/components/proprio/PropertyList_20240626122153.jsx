                ...
                <table className="min-w-full bg-white">
                    <thead>
                        <tr>
                            ...
                            <th className="py-2 text-left px-4 bg-gray-100">Nombre de personnes max</th>
                    ...
                    <tbody>
                        {properties.map((property) => (
                            <tr key={property.id}>
                                ...
                                <td className="py-2 px-4 border-b">{property.area}</td>
                                <td className="py-2 px-4 border-b">{property.hasBalcony ? 'Oui' : 'Non'}</td>
                                <td className="py-2 px-4 border-b">{property.active ? 'Active' : 'Inactive'}</td>
