...
const ProprietaireReservation = () => {
    ...
    const pendingPrestations = prestations.filter(prestation => prestation.statut === 'en attente' && new Date(prestation.dateDEffet) >= now );
    const ongoingPrestations = prestations.filter(prestation => prestation.statut === 'Confirmée' && new Date(prestation.active === true));
    const pastPrestations = prestations.filter(prestation => prestation.statut === 'Passée' || new Date(prestation.dateDEffet) < now);
