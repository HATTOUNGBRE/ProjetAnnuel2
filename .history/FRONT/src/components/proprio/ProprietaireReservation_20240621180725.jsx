...
const ProprietaireReservation = () => {
    ...
    const pendingReservations = reservations.filter(reservation => reservation.statut === 'en attente' && new Date(reservation.dateDEffet) >= now && reservation.valide === true);
    ...
    return (
        <div className="ml-auto content-center justify-center max-w-4xl  flex flex-col flex  mt-16 mb-16 p-8 bg-white shadow-lg rounded-lg">
