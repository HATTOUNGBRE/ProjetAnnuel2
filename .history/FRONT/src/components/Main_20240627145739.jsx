  ...
  return (
    <div className="min-h-screen bg-pcs-100 flex flex-col items-center justify-center">
      ...
      <div className="mt-10 w-full">
        <h2 className=" ml-4 text-2xl font-semibold text-pcs-400 mb-6">Appartements Populaires</h2>
      ...
      <div className="mt-10 w-full">
        <h2 className=" ml-4 text-2xl font-semibold text-pcs-400 mb-6">Nouveaux Appartements</h2>
        <Slider {...sliderSettings}>
          {[1, 2, 3, 4, 5].map(item => (
            <div key={item} className="p-4">
              <div className="bg-white shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="mt-10 w-full">
        <h2 className=" ml-4 text-2xl font-semibold text-pcs-400 mb-6">Appartements de Luxe</h2>
        <Slider {...sliderSettings}>
          {[1, 2, 3, 4, 5].map(item => (
            <div key={item} className="p-4">
              <div className="bg-white shadow-lg rounded-lg overflow-hidden">
