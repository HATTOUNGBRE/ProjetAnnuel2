...
function Main() {
  ...
  return (
    <div className="min-h-screen bg-pcs-100 flex flex-col items-center justify-center">
      ...
      <PropertyRowSlider title="Appartements Populaires" apiUrl="http://localhost:8000/api/properties/popular" sliderSettings={sliderSettings} />
      <PropertyRowSlider title="Nouveaux Appartements" apiUrl="http://localhost:8000/api/properties/new" sliderSettings={sliderSettings} />
      <PropertyRowSlider title="Appartements de Luxe" apiUrl="http://localhost:8000/api/properties/luxury" sliderSettings={sliderSettings} />
    </div>
  );
}
