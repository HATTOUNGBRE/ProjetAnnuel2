...
import ReservationForm from './voyageur/ReservationForm';
                ...
                <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-between">
                      <button className="bg-pcs-250 hover:bg-pcs-200 text-white py-2 px-4 rounded-md" onClick={() => handleShowDetails(property)}>Détail +</button>
                      <button className="bg-pcs-400 text-white py-2 px-4 rounded-md" onClick={() => handleShowReservationForm(property)}>Louer</button>
                    </div>
                  </div>
                </div>
              </div>
