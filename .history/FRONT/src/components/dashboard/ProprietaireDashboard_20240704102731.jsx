                        ...
                        <ul className='dmd_active'>
                            {activeDemandes.map(demande => (
                                <li key={demande.id} className="bg-white shadow-md rounded-lg p-4 mb-4">
                                    ...
                                    <p>Voyageur: {demande.name} {demande.surname}</p>
                                    ...
                                    <button onClick={() => handleAccept(demande.id)} className="bg-blue-500 text-white py-1 px-3 rounded mt-2">Accepter</button>
                                </li>
                            ))}
                        </ul>
                    )}
