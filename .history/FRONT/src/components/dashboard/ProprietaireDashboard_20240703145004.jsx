...
import { FaHome, FaClipboardList, FaUsers, FaCog, FaPlus, FaCalendarAlt } from 'react-icons/fa';
...
const ProprietaireDashboard = () => {
    ...
    const handleAccept = async (demandeId) => {
        try {
            ...
            setMessage('La demande a été acceptée avec succès.');
        ...
        <div className="flex h-screen bg-pcs-100">
            ...
            <div className="flex-1 p-6 flex flex-col mb-18">
                ...
                <div className="mt-6 mb-18">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4">Demandes de Réservation</h2>
