      ...
      <div className="flex-1 p-6 overflow-auto">
        ...
        <div className="mt-6">
          <div className="grid gap-6 mb-8 md:grid-cols-2">
            <div className="min-w-0 w-full p-4 bg-white rounded-lg shadow-xs">
              ...
              <ul className="divide-y divide-gray-200">
                {reservations.map(reservation => (
                  <li key={reservation.id} className="py-4 flex justify-between items-center">
                    <div>
                      <h6 className="text-normal font-semibold text-gray-800">{reservation.titre}</h6>
                    ...
                    <div className="space-x-2">
                      <button className="bg-pcs-400 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition">Accepter</button>
