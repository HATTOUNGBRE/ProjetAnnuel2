            ...
            <div className="w-64 bg-pcs-250 shadow-md">
                <div className="p-6">
                    ...
                    <nav className="mt-10">
                        ...
                        <Link to="/add-prestation" className="flex items-center p-2 mt-4 text-pcs-100 transition-colors duration-200 transform rounded-md hover:bg-gray-200 hover:text-gray-700">   
                            <FaPlus className="w-5 h-5" />
