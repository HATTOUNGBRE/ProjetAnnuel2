            ...
            <Page style={styles.page}>
                ...
                {payments.map((payment, index) => (
                    <View key={index} style={styles.section}>
                        ...
                        <Text style={styles.text}>Numéro de Réservation: {payment.reservation.reservationNumber}</Text>
    ...
    return (
        <div className="container mx-auto p-6 bg-white rounded-lg shadow-md">
            ...
            <table className="min-w-full bg-white">
                <thead>
                    <tr>
                        <th className="py-2 px-4 bg-gray-200 text-gray-600 font-bold">Date</th>
                        <th className="py-2 px-4 bg-gray-200 text-gray-600 font-bold">Montant</th>
                        <th className="py-2 px-4 bg-gray-200 text-gray-600 font-bold">Méthode</th>
                        ...
                        <th className="py-2 px-4 bg-gray-200 text-gray-600 font-bold">Prix total</th>
                    </tr>
                </thead>
                <tbody>
                    {payments.map((payment, index) => (
                        <tr key={index} className="border-b">
                            ...
                            <td className="py-2 px-4">{payment.reservation.totalPrice} €</td>
                        </tr>
                    ))}
                </tbody>
            </table>
            <div className="mt-4">
                <PDFDownloadLink document={<PaymentDocument payments={payments} />} fileName="payments.pdf">
                    {({ loading }) => (
                        <button className="bg-pcs-300 text-white py-2 px-4 rounded-lg hover:bg-pcs-400">
