...
function Main() {
  ...
  return (
    <div className="min-h-screen bg-pcs-100 flex flex-col items-center justify-center">
      ...
      <SearchResults searchTerm={searchTerm} maxPersons={maxPersons} handleShowDetails={handleShowDetails} />

      {/* Section pour toutes les propriétés */}
      <div className="mt-10 w-full">
        <h2 className="text-2xl font-semibold text-pcs-400 mb-6">Toutes les Propriétés</h2>
        <PropertyRow properties={allProperties} sliderSettings={sliderSettings} handleShowDetails={handleShowDetails} />
      </div>
