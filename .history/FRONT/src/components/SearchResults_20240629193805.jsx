...
import PropertyDetails from './PropertyDetails'; // Assurez-vous d'importer votre composant PropertyDetails
          ...
          <div key={property.id} className="bg-white shadow-lg rounded-lg overflow-hidden m-4 w-1/4">
            ...
            <div className="p-4">
              ...
              <div className="flex justify-between">
                ...
                <Link to={`/louer-un-logement?id=${property.id}`} target="_blank" className="bg-pcs-400 text-white py-2 px-4 rounded-md">Louer</Link>
              </div>
            </div>
          </div>
        ))}
